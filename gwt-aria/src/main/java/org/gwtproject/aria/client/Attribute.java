...
/**
 * Class representing ARIA state/property attribute. Contains methods for setting, getting, removing
 * ARIA attributes for an HTML {@link org.gwtproject.dom.client.Element}.
 *
 * <p>For more details about ARIA states and properties check the W3C ARIA documentation <a
 * href="http://www.w3.org/TR/wai-aria/states_and_properties">Supported States and Properties </a>.
 *
