...
public interface RangeRole extends WidgetRole {
   ...
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuemax">aria-valuemax</a>
  ...
  /**
   * Returns the value of the <a
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuemin">aria-valuemin</a>
   * attribute for the {@code element} or "" if no such attribute is present.
   */
  ...
  /**
   * Returns the value of the <a
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuenow">aria-valuenow</a>
   * attribute for the {@code element} or "" if no such attribute is present.
   */
  ...
  /**
   * Returns the value of the <a
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuetext">aria-valuetext</a>
   * attribute for the {@code element} or "" if no such attribute is present.
   */
  String getAriaValuetextProperty(Element element);

  /**
   * Removes the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuemax">
   * aria-valuemax</a> attribute from the {@code element}.
   */
  void removeAriaValuemaxProperty(Element element);

  /**
   * Removes the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuemin">
   * aria-valuemin</a> attribute from the {@code element}.
   */
  void removeAriaValueminProperty(Element element);

  /**
   * Removes the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuenow">
   * aria-valuenow</a> attribute from the {@code element}.
   */
  void removeAriaValuenowProperty(Element element);

  /**
   * Removes the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuetext">
   * aria-valuetext</a> attribute from the {@code element}.
   */
  void removeAriaValuetextProperty(Element element);

  /**
   * Sets the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuemax">
  ...
  /**
   * Sets the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuemin">
  ...
  /**
   * Sets the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuenow">
  ...
  /**
   * Sets the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-valuetext">
