...
public interface ButtonRole extends CommandRole {
   ...
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-expanded">aria-expanded</a>
  ...
  /**
   * Returns the value of the <a
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-pressed">aria-pressed</a>
   * attribute for the {@code element} or "" if no such attribute is present.
   */
  String getAriaPressedState(Element element);

  /**
   * Removes the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-expanded">
   * aria-expanded</a> attribute from the {@code element}.
   */
  void removeAriaExpandedState(Element element);

  /**
   * Removes the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-pressed">
   * aria-pressed</a> attribute from the {@code element}.
   */
  void removeAriaPressedState(Element element);

  /**
   * Sets the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-expanded">
  ...
  /**
   * Sets the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-pressed">
