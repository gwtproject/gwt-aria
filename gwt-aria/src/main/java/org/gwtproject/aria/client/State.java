 ...
 *
 * <ol>
 *   <li>Widget states -- specific to common user interface elements found on GUI systems or in rich
 *       Internet applications which receive user input and process user actions
 *   <li>Live Region states -- specific to live regions in rich Internet applications; may be
