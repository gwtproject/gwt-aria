...
public interface TextboxRole extends InputRole {
   ...
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-activedescendant">
  ...
  /**
   * Returns the value of the <a
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-autocomplete">
  ...
  /**
   * Returns the value of the <a
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-multiline">aria-multiline</a>
  ...
  /**
   * Returns the value of the <a
   * href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-readonly">aria-readonly</a>
   * attribute for the {@code element} or "" if no such attribute is present.
   */
  ...
  /**
   * Removes the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-autocomplete">
   * aria-autocomplete</a> attribute from the {@code element}.
   */
  void removeAriaAutocompleteProperty(Element element);

  /**
   * Removes the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-multiline">
   * aria-multiline</a> attribute from the {@code element}.
   */
  void removeAriaMultilineProperty(Element element);

  /**
   * Removes the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-readonly">
  ...
  /**
   * Sets the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-autocomplete">
  ...
  /**
   * Sets the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-multiline">
  ...
  /**
   * Sets the <a href="http://www.w3.org/TR/wai-aria/states_and_properties#aria-readonly">
