...
/**
 * Class that contains constants for all ARIA properties as defined by the W3C specification <a
 * href="http://www.w3.org/TR/wai-aria/">W3C ARIA specification</a>.
 *
 ...
 *
 * <ol>
 *   <li>Widget properties -- specific to common user interface elements found on GUI systems or in
 *       rich Internet applications which receive user input and process user actions
...
public final class Property {
  ...
  public static final Attribute<Id> CONTROLS = new AriaValueAttribute<Id>("aria-controls", "");
  ...
  public static final Attribute<Id> FLOWTO = new AriaValueAttribute<Id>("aria-flowto", "");
  ...
  public static final Attribute<Id> LABELLEDBY = new AriaValueAttribute<Id>("aria-labelledby", "");
  ...
  public static final Attribute<Id> OWNS = new AriaValueAttribute<Id>("aria-owns", "");
